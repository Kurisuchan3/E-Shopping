...
export function Sidebar() {
  ...
  return (
    <div className="flex min-h-screen w-72 shrink-0 flex-col overflow-y-auto bg-gray-400 pb-6 text-white">
      ...
      <div className="flex flex-col space-y-2 px-6 text-black">
        <SidebarLink
